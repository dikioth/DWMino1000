...
// connection pins. Assuming SPI pins connected.
 ...
 *     - byte 10/11: frame check-sum (FCS), automatically set by DW1000.  */
...
void setup()
{
    ...
    /* 
     TODO: Reset and initialise DW1000. See NOTE 2 below.
     * For initialisation, DW1000 clocks must be temporarily set to crystal speed. After initialisation SPI rate can be increased for optimum
     * performance. */
    SPI.beginTransaction(SPISettings(1000000, MSBFIRST, SPI_MODE0)); // Set SPI rate to less than 3 MHz (1Mhz)
    ...
    SPI.beginTransaction(SPISettings(14000000, MSBFIRST, SPI_MODE0)); // Set SPI rate to higher than 3 MHz (14MHz)
